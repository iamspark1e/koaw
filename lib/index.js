    ...
    route() {
        return (ctx) => __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < tasks.length; i++) {
                let handlerRes = yield tasks[i].handler(ctx, tasks[i].match);
                if (!(handlerRes instanceof ApplicationContext)) {
                    throw new TypeError("`KoawRouter` handler didn't return correct context");
                }
                if (ctx.finished)
                    break;
            }
...
class Koaw {
    ...
    contextToResponse(ctx) {
        ...
        const resp = {
            ...
            redirect: ((_b = ctx.res) === null || _b === void 0 ? void 0 : _b.redirect) || "",
            status: ((_c = ctx.res) === null || _c === void 0 ? void 0 : _c.status) || 404,
            statusText: ((_d = ctx.res) === null || _d === void 0 ? void 0 : _d.statusText) || "",
            headers: ((_e = ctx.res) === null || _e === void 0 ? void 0 : _e.headers) || {},
        };
        const respInit = {
            status: resp.status,
            headers: new Headers(resp.redirect
                ? Object.assign(Object.assign({}, resp.headers), { Location: resp.redirect }) : resp.headers),
        };
            ...
            try {
                ...
                for (let i = 0; i < handlersCount; i++) {
                    if (this.ctx.finished)
                        break;
                    let middlewareRes = yield this.middleware[i](this.ctx);
                    this.ctx.res = middlewareRes.res;
                }
                for (let j = 0; j < this.ctx.tailHandlers.length; j++) {
                    let handlerRes = yield this.ctx.tailHandlers[j](this.ctx).res;
